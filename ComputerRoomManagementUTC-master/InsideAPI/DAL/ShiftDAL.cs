...
namespace InsideAPI.DAL
{
    public class ShiftDAL
    {
        ...
        {
            List<Shift> mouseList = new List<Shift>();
            DbProvider dbProvider = new DbProvider();
            string outCode = String.Empty;
            string outMessage = String.Empty;
            int totalRows = 0;
            StoredProcedureConfigs<Shift> storedProcedureConfigs = new StoredProcedureConfigs<Shift>();
        ...
        public ReturnResult<Shift> Add(AddShiftModel mouse)
        {
            DbProvider dbProvider = new DbProvider();
            string outCode = String.Empty;
            string outMessage = String.Empty;
